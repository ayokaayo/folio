      ...
      <section className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 py-8 md:py-12">
        ...
        >
          ...
          <div className="space-y-6 text-base md:text-lg text-text/80 leading-relaxed">
            ...
            <p>
              My career started in graphic design but my strongest contributions have been in design ops, product
              strategy, and systems thinking. I can code and speak developer fluently, which really helps when you&apos;re working closely with engineering teams.
            </p>
            <p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <motion.div
              ...
              className="p-6 rounded-lg border border-text/10 bg-brand-green md:col-span-2"
            >
              <div className="flex items-start gap-3 mb-3">
                <svg className="w-6 h-6 text-text/70 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
